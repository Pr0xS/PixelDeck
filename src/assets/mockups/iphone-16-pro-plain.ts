/**
 * iPhone 16 Pro mockup — variant WITHOUT Dynamic Island.
 * Identical to iphone-16-pro.ts except the Dynamic Island pill is removed.
 * ViewBox: 0 0 390 844
 */
export const IPHONE_16_PRO_PLAIN_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390 844" fill="none">
  <defs>
  ...
  <!-- No Dynamic Island in this variant -->
...
export default IPHONE_16_PRO_PLAIN_SVG
