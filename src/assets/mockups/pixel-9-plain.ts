/**
 * Google Pixel 9 mockup — variant WITHOUT punch-hole camera.
 * Identical to pixel-9.ts except the punch-hole circle is removed.
 * ViewBox: 0 0 380 820
 */
export const PIXEL_9_PLAIN_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 820" fill="none">
  <defs>
  ...
  <!-- No punch-hole camera in this variant -->
...
export default PIXEL_9_PLAIN_SVG
